...
: ${AMENT_CURRENT_PREFIX:="/usr/sdelasa/install/autoronto_interview"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/autoronto_interview/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/autoronto_interview/environment/path.sh"
